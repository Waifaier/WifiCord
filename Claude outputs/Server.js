...
const ServerModel = {
  ...
  toPublic(server) { return {id:server.id,name:server.name,ownerId:server.owner_id,inviteCode:server.invite_code,createdAt:server.created_at,iconUrl:server.icon_url||null,bannerUrl:server.banner_url||null,backgroundUrl:server.background_url||null}; },
